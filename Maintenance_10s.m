...
@implementation Maintenance_10s
...
//    }else{
        ...
        [[NSUserDefaults standardUserDefaults] setObject:UIImageJPEGRepresentation(profilePhoto.image, .3) forKey:@"BountiqueAcylicRepairPhoto"];
