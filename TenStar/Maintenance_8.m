...
-(void)createUI{
    ...
    question.text = @"Is paint touch up required ?";
...
-(void)nextAction{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:paint forKey:@"paintTouchUp"];
    [[NSUserDefaults standardUserDefaults]synchronize];

    
    
    
    Maintenance_9 * maintenance_9 = [[Maintenance_9 alloc]init:_doorName Doorid:_doorID];
    [self.navigationController pushViewController:maintenance_9 animated:YES];
