...
-(void)createUI{
    ...
    question.text = @"Select the final picture of \n Door Maintenance";
    ...
    if(screenRect.size.width<=320)
        ...
        profilePhoto.frame=CGRectMake(screenRect.size.width/2-75, question.frame.origin.y+question.frame.size.height, 150, 150);
...
//    }else{
        ...
        [[NSUserDefaults standardUserDefaults] setObject:UIImageJPEGRepresentation(profilePhoto.image, .3) forKey:@"FinalDoor"];
        [[NSUserDefaults standardUserDefaults]synchronize];
        
    Maintenance_14 * maintenance_14 = [[Maintenance_14 alloc]init:_doorName Doorid:_doorID];
    [self.navigationController pushViewController:maintenance_14 animated:YES];
    }
    //}
