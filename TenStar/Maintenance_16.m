...
-(void)createUI{
    ...
    question.text = @"Hotspot Replaced ?";
...
-(void)nextAction{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:headerAcylic forKey:@"Hotspot"];
    [[NSUserDefaults standardUserDefaults]synchronize];
    
    
    Maintenance_13 * maintenance_13 = [[Maintenance_13 alloc]init:_doorName Doorid:_doorID];
    [self.navigationController pushViewController:maintenance_13 animated:YES];
