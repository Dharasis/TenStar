...
#import "Maintenance3.h"

@interface Maintenance3 ()
{
...
-(void)createUI{
    ...
    question.text = @"Select the picture of Wall Unit";
...
//    }else{
        ...
        [[NSUserDefaults standardUserDefaults] setObject:UIImageJPEGRepresentation(profilePhoto.image, .3) forKey:@"WallUnitPic"];
        [[NSUserDefaults standardUserDefaults]synchronize];
        
        
    Maintenance_4 * maintenance_4 = [[Maintenance_4 alloc]init:_doorName Doorid:_doorID];
    [self.navigationController pushViewController:maintenance_4 animated:YES];
