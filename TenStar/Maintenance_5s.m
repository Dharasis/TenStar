...
@interface Maintenance_5s ()

@end

@implementation Maintenance_5s
{
...
-(void)createUI{
    ...
    question.text = @"Select the picture of\nOld Transformer";
...
//    }else{
        ...
        [[NSUserDefaults standardUserDefaults] setObject:UIImageJPEGRepresentation(profilePhoto.image, .3) forKey:@"OldTransformerPhoto"];
        [[NSUserDefaults standardUserDefaults]synchronize];
        
            Maintenance_6 * maintenance_6 = [[Maintenance_6 alloc]init:_doorName Doorid:_doorID];
            [self.navigationController pushViewController:maintenance_6 animated:YES];
