...
//    }else{
        ...
        [[NSUserDefaults standardUserDefaults] setObject:UIImageJPEGRepresentation(profilePhoto.image, .3) forKey:@"NewWirePhoto"];
        [[NSUserDefaults standardUserDefaults]synchronize];

        Maintenance_7 * maintenance_7 = [[Maintenance_7 alloc]init:_doorName Doorid:_doorID];
       [self.navigationController pushViewController:maintenance_7 animated:YES];
   // }
    //
}
