...
-(void)createUI{
    ...
    question.text = @"Hotspot Acrylic Replace ?";
...
-(void)nextAction{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:headerAcylic forKey:@"HeaderAcylic"];
    [[NSUserDefaults standardUserDefaults]synchronize];
    

    if(yes){
        Maintenance_11s * maintenance_11s = [[Maintenance_11s alloc]init:_doorName Doorid:_doorID];
        [self.navigationController pushViewController:maintenance_11s animated:YES];
