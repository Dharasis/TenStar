...
-(void)nextAction{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:cableService forKey:@"cableService"];
    ...
    if(yes){
        ...
        Maintenance_6s * maintenance_6S = [[Maintenance_6s alloc]init:_doorName Doorid:_doorID];
        [self.navigationController pushViewController:maintenance_6S animated:YES];
         }else{
